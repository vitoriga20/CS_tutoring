...
| 文件 | 版本 | 关键词 | 状态 | 相关模块 |
|---|---|---|---|---|
| 001-v1-init-cs-tutoring.md | v1 | bootstrap、supabase-独立新建、免登录、终末地审美 | 活跃 | 工作区、数据层、前端、鉴权 |
| 002-v1-spec-v020-approved.md | v1 | spec、v0.2.0、已批准、闭环排期#001 | 活跃 | 工作区、数据层、前端、鉴权 |
